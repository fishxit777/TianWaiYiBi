...
- 2026-09-13 V31 本機完整驗證：第 1 輪完成 36 張現代圖與專屬圖說，但 390×844 發現第拾參卷長標題在窄版過於擁擠，因此標準 3 判定不通過；第 2 輪加入長標題安全換行與窄版排版後通過。完整 `python -m pytest -q` 為 169 passed、1 skipped。精確 390×844 為頁面寬 390、水平溢位 0、三圖全載入、三圖說可見、拆解區單欄；1280×720 為水平溢位 0、三圖全載入、拆解區雙欄。公開收款維持關閉，隔離 QA 不作市場需求證據。正式提交、推送與部署驗證待本輪完成後補記。
