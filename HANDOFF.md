...
2026-08-30 V23 已建立「雲上仙伴」圖文互動系統：六脈各有固定 Q 版仙伴守雲、鑄星、玄算、弈川、桃夭與清商，首屏、六脈卡、封印卡、拆封三步與頁尾均有對應插圖；滑入、鍵盤焦點與點擊會顯示短句並播放角色動作。互動不送出 API、不記錄分析，也不得算成真人或市場需求。六張透明 WebP 均低於 116 KB；公開收款、盲策內容、交易、安全與資料庫規則沒有改動。
