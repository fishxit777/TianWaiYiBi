...
> V32最新補強與未驗證邊界見`updates/2026-09-13-independent-content-security-v32.md`。以下為歷史複查；留言／客戶LINE已於V26退役，不得照此舊文復建。2026-08-26金流閉環已驗收，而V32另外修補原未涵蓋的靜態付費圖片存取；兩者證據分開看待。
